...
function compatibilityIdentityValue(value, fallback) {
...
function identity(profile, callerIdentity = {}) {
  return {
    playerId: compatibilityIdentityValue(
      profile?.playerId ?? callerIdentity.playerId,
      "UNKNOWN"
    ),
    playerName: compatibilityIdentityValue(
      profile?.playerName ?? callerIdentity.playerName,
      "Unknown Player"
    ),
    position: compatibilityIdentityValue(
      profile?.position ?? callerIdentity.position,
      "UNKNOWN"
    ),
  };
}
