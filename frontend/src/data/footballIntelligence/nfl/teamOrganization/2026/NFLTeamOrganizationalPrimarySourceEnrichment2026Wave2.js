...
const entries = [
  // Baltimore Ravens
  // Official club Player Personnel roster. Public projection already allows these governed role families.
  ...
  fact({ team:"BAL", domain:"EXECUTIVE_LEADERSHIP", role:"PRESIDENT", displayName:"Sashi Brown", title:"President", authorityScopes:["BUSINESS"], sourceId:"ravens-front-office-2026", sourceType:"OFFICIAL_CLUB", sourceLabel:"Ravens Front Office Roster", sourceUri:BAL }),
  fact({ team:"BAL", role:"PERSONNEL_ADVISOR", displayName:"Ozzie Newsome", title:"Executive Vice President", authorityScopes:["FOOTBALL_OPERATIONS","PERSONNEL","DRAFT","ROSTER"], reportsToRole:"GENERAL_MANAGER", sourceId:"ravens-front-office-2026", sourceLabel:"Ravens Front Office Roster", sourceUri:BAL }),
  ...
  fact({ team:"BAL", role:"FOOTBALL_OPERATIONS_EXECUTIVE", displayName:"David McDonald", title:"Vice President of Football Science", authorityScopes:["FOOTBALL_OPERATIONS","PERSONNEL"], reportsToRole:"GENERAL_MANAGER", sourceId:"ravens-front-office-2026", sourceLabel:"Ravens Front Office Roster", sourceUri:BAL }),
  ...
  fact({ team:"BAL", role:"PLAYER_PERSONNEL_EXECUTIVE", displayName:"Andrew Raphael", title:"Assistant Director of Player Personnel", authorityScopes:["PERSONNEL","DRAFT","ROSTER"], reportsToRole:"GENERAL_MANAGER", sourceId:"ravens-front-office-2026", sourceLabel:"Ravens Front Office Roster", sourceUri:BAL }),
  fact({ team:"BAL", role:"PLAYER_PERSONNEL_EXECUTIVE", displayName:"Bobby Vega", title:"Assistant Director of Player Personnel", authorityScopes:["PERSONNEL","DRAFT","ROSTER"], reportsToRole:"GENERAL_MANAGER", sourceId:"ravens-front-office-2026", sourceLabel:"Ravens Front Office Roster", sourceUri:BAL }),
  fact({ team:"BAL", role:"FOOTBALL_OPERATIONS_EXECUTIVE", displayName:"Steve Clagett Jr.", title:"Director of Football Innovation", authorityScopes:["FOOTBALL_OPERATIONS","PERSONNEL"], reportsToRole:"GENERAL_MANAGER", sourceId:"ravens-front-office-2026", sourceLabel:"Ravens Front Office Roster", sourceUri:BAL }),
  fact({ team:"BAL", role:"FOOTBALL_OPERATIONS_EXECUTIVE", displayName:"James Oncea", title:"Director of Football Systems", authorityScopes:["FOOTBALL_OPERATIONS","PERSONNEL"], reportsToRole:"GENERAL_MANAGER", sourceId:"ravens-front-office-2026", sourceLabel:"Ravens Front Office Roster", sourceUri:BAL }),
  fact({ team:"BAL", role:"FOOTBALL_OPERATIONS_EXECUTIVE", displayName:"Derrick Yam", title:"Director of Data & Decision Science", authorityScopes:["FOOTBALL_OPERATIONS","PERSONNEL","DRAFT","ROSTER"], reportsToRole:"GENERAL_MANAGER", sourceId:"ravens-front-office-2026", sourceLabel:"Ravens Front Office Roster", sourceUri:BAL }),
  fact({ team:"BAL", role:"FOOTBALL_OPERATIONS_EXECUTIVE", displayName:"Jenn Hoffman", title:"Chief of Staff to the General Manager", authorityScopes:["FOOTBALL_OPERATIONS"], reportsToRole:"GENERAL_MANAGER", sourceId:"ravens-front-office-2026", sourceLabel:"Ravens Front Office Roster", sourceUri:BAL }),
  fact({ team:"BAL", role:"SCOUTING_EXECUTIVE", displayName:"Brandon Berning", title:"National Scout", authorityScopes:["PERSONNEL","DRAFT"], reportsToRole:"COLLEGE_SCOUTING_EXECUTIVE", sourceId:"ravens-front-office-2026", sourceLabel:"Ravens Front Office Roster", sourceUri:BAL }),
  fact({ team:"BAL", role:"SCOUTING_EXECUTIVE", displayName:"Chas Stallard", title:"National Scout", authorityScopes:["PERSONNEL","DRAFT"], reportsToRole:"COLLEGE_SCOUTING_EXECUTIVE", sourceId:"ravens-front-office-2026", sourceLabel:"Ravens Front Office Roster", sourceUri:BAL }),
  fact({ team:"BAL", role:"SCOUTING_EXECUTIVE", displayName:"Q Attenoukon", title:"West Coast Area Scout", authorityScopes:["PERSONNEL","DRAFT"], reportsToRole:"COLLEGE_SCOUTING_EXECUTIVE", sourceId:"ravens-front-office-2026", sourceLabel:"Ravens Front Office Roster", sourceUri:BAL }),
  fact({ team:"BAL", role:"SCOUTING_EXECUTIVE", displayName:"Patrick McDonough", title:"Southeast Area Scout", authorityScopes:["PERSONNEL","DRAFT"], reportsToRole:"COLLEGE_SCOUTING_EXECUTIVE", sourceId:"ravens-front-office-2026", sourceLabel:"Ravens Front Office Roster", sourceUri:BAL }),
  fact({ team:"BAL", role:"SCOUTING_EXECUTIVE", displayName:"Joe Moreno", title:"Northeast Area Scout", authorityScopes:["PERSONNEL","DRAFT"], reportsToRole:"COLLEGE_SCOUTING_EXECUTIVE", sourceId:"ravens-front-office-2026", sourceLabel:"Ravens Front Office Roster", sourceUri:BAL }),
  fact({ team:"BAL", role:"SCOUTING_EXECUTIVE", displayName:"Terrell Parker", title:"Central Area Scout", authorityScopes:["PERSONNEL","DRAFT"], reportsToRole:"COLLEGE_SCOUTING_EXECUTIVE", sourceId:"ravens-front-office-2026", sourceLabel:"Ravens Front Office Roster", sourceUri:BAL }),
  fact({ team:"BAL", role:"SCOUTING_EXECUTIVE", displayName:"Jojo Wooden", title:"West Coast Area Scout", authorityScopes:["PERSONNEL","DRAFT"], reportsToRole:"COLLEGE_SCOUTING_EXECUTIVE", sourceId:"ravens-front-office-2026", sourceLabel:"Ravens Front Office Roster", sourceUri:BAL }),
  fact({ team:"BAL", role:"FOOTBALL_OPERATIONS_EXECUTIVE", displayName:"Sophie Cortese", title:"Assistant Director of Football Administration", authorityScopes:["FOOTBALL_OPERATIONS"], reportsToRole:"GENERAL_MANAGER", sourceId:"ravens-front-office-2026", sourceLabel:"Ravens Front Office Roster", sourceUri:BAL }),
  fact({ team:"BAL", role:"PRO_SCOUTING_EXECUTIVE", displayName:"TJ Ajibola", title:"Pro Scout", authorityScopes:["PERSONNEL","ROSTER"], reportsToRole:"PRO_SCOUTING_EXECUTIVE", sourceId:"ravens-front-office-2026", sourceLabel:"Ravens Front Office Roster", sourceUri:BAL }),
