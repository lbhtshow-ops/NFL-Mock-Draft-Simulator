...
export function createNFLTeamPerformanceEvidence({
  ...
  return {
    ...
    specialTeams:
      specialTeams && typeof specialTeams === "object"
        ? {
            plays: nonNegativeInteger(specialTeams.plays),
            epa: finiteOrNull(specialTeams.epa),
            epaPerPlay: finiteOrNull(specialTeams.epaPerPlay),
            fieldGoalPlays: nonNegativeInteger(specialTeams.fieldGoalPlays),
            puntPlays: nonNegativeInteger(specialTeams.puntPlays),
            kickoffPlays: nonNegativeInteger(specialTeams.kickoffPlays),
            extraPointPlays: nonNegativeInteger(specialTeams.extraPointPlays),
          }
        : null,
    ...
    scheduleContext:
      scheduleContext && typeof scheduleContext === "object"
        ? {
            games: Array.isArray(scheduleContext.games)
              ? scheduleContext.games
              : [],
            regularSeasonGames: nonNegativeInteger(
              scheduleContext.regularSeasonGames
            ),
            postseasonGames: nonNegativeInteger(
              scheduleContext.postseasonGames
            ),
          }
        : {
            games: [],
    ...
    phaseScope:
      ["REGULAR", "POSTSEASON", "ALL"].includes(phaseScope)
        ? phaseScope
        : "ALL",
