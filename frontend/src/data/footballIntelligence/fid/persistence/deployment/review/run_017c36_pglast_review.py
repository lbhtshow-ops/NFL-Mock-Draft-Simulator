"""Offline parser reproduction for Sprint 17C.36; never executes PostgreSQL."""
import json
import re
...
sql = Path(__file__).with_name("017c36_fid_function_owner_capability_mismatch_detail_split_authority_correction.sql").read_text(encoding="utf-8")
