"""Offline parser reproduction for Sprint 17C.40; never executes PostgreSQL."""
import json
import re
...
sql = Path(__file__).with_name("017c40_fid_function_owner_capability_mismatch_detail_split_authority_25_field_successor.sql").read_text(encoding="utf-8")
...
print(json.dumps({"tool": f"pglast {pglast.__version__}", "grammar": parser.get_postgresql_version(),
  ...
  "dynamicStatementsParsed": 1, "dynamicStatementTypes": sorted(dynamic_types), "visibleSelectFields": 25,
