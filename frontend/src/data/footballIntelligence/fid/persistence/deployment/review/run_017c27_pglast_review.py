"""Offline Sprint 17C.27 parser review; never connects to or executes PostgreSQL."""
...
SQL_PATH = Path(__file__).with_name(
    "017c27_fid_function_owner_capability_acl_matrix_dashboard_visible_preflight_custom_setting_correction.sql"
)
MUTATING = {
